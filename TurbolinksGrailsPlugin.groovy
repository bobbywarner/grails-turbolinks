class TurbolinksGrailsPlugin {
    ...
    def description = "Plugin that makes following links in your web application faster by leveraging Turbolinks"
    def documentation = "http://bobbywarner.github.com/grails-turbolinks"
    def license = "MIT"
